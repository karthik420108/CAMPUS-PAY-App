...
function AdminVendorComplaints() {
  ...
  if (loading) {
    return <div style={{ padding: "20px" }}>Loading vendor complaints...</div>;
  }
  ...
  return (
    <>
      ...
      {currentComplaints.length === 0 ? (
        <p>
          {activeTab === "pending" 
            ? "No pending vendor complaints found." 
            : "No resolved vendor complaints found."
          }
        </p>
      ) : (
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ margin: "5px 0" }}>
                    <strong>From:</strong> {complaint.userId?.vendorName} 
                    ({complaint.userId?.Email}) - ID: {complaint.userId?.vendorId}
                  </p>
